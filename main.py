...
class TextVoiceLangSplit(Star):
    ...
    async def _translate_text(self, text: str, event: AstrMessageEvent) -> str | None:
        ...
        prompt = (
            ...
            f"5. STRICTLY NO BACK-TO-BACK STACKING: Never place an emotion tag "
            f"immediately next to an audio-effect/vocalization tag "
            f"(wrong: [scared] [gasp] text; correct: [scared] text).\n"
            f"6. NO REDUNDANT ONOMATOPOEIA (CRITICAL): If you use a physical "
            ...
            f"like ふぅ… びっくりした).\n"
            f"7. ALWAYS FOLLOW WITH NORMAL TEXT: According to Fish Audio official "
            ...
            f"8. KEEP IT EXTREMELY SIMPLE: Do not overuse tags in short text. "
