...
class TextVoiceLangSplit(Star):
    ...
    async def _translate_text(self, text: str, event: AstrMessageEvent) -> str | None:
        ...
        prompt = (
            ...
            f"4. STRICTLY NO BACK-TO-BACK STACKING: Never place an emotion tag "
            f"immediately next to an audio-effect/vocalization tag "
            f"(wrong: [scared] [gasp] text; correct: [scared] text).\n"
